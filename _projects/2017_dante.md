---
title: "DANTE"
thumb: '/images/projects/dante.png'
collection: portfolio
---

DANTE (Dimensional ANnotation Tool for Emotions) is an emotional annotation web tool to annotate any kind of video in terms of valence and arousal continuous dimensions.

DANTE is a project developed by the [PHuSe Lab](http://phuselab.di.unimi.it "PHuSe Lab") from Università degli Studi di Milano, Italy, in collaboration with Département Informatique de Ecole Polytechnique de l'Université François Rabelais de Tours, France. The tool is part of a multimodal dataset acquired with the aim to study emotional response in presence of amusement stimulus.
...
[https://github.com/PHuSeLab/DANTE](https://github.com/PHuSeLab/DANTE)